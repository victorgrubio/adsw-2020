...
public class PruebaDetectorVehiculosOrig {
	public static void main (String[] args) {
		...
		SelectorVehiculo s3 = new SelectorVehiculoCompatible(new Vector (50.0, 50.0),
		50); vss = dv4.getVehiculos(s3);
		System.out.println("GetVehiculosCompatibles: "); for (Vehiculo v : vss)
		System.out.println(v);
